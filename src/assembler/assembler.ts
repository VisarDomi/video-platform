    ...
    try {
        ...
        await runCommand(
            ...
            [
                ...
                // Input Driver
                "-f",
                "concat", // Use the concat demuxer, which reads a list of files to concatenate.
                "-safe",
                "0", // Allows absolute paths in the file list. Necessary since we use full paths.
                "-i",
                fileListPath,

                // Core Operation
                "-c",
                "copy", // Stream copy. This is VITAL. We are not re-encoding the video or audio.
