...
# Rate control mode: Use "vbr" for 2-pass (best quality/size) or "cbr" for 1-pass (Constant Bitrate).
# VBR is highly recommended for file-based encoding.
RATE_CONTROL="vbr"

# Target bitrate in kb/s. "5000k" means 5000 kilobits per second.
TARGET_BITRATE="5000k"

# NVENC preset. p4 is a good balance. Slower presets (p5-p7) can improve quality.
PRESET=p4
...
echo "Found $total_files video(s) to process with a target bitrate of $TARGET_BITRATE."
echo "---"
...
echo "Videos are located in: $OUTPUT_DIR"
echo "=========================================================="