export type LogEvent =
    ...
    | { event: 'media-duration-mismatch'; slot: number; filename: string; phase: string; playlistDuration: number; mediaDuration: number | null; seekableEnd: number | null; durationDelta: number | null; seekableDelta: number | null; currentTime: number; durationSource: 'playlist' | 'seekable' | 'media' | 'none' | 'live'; playlistTime: number | null; playbackToPlaylistScale: number; currentSegmentName: string | null; currentSegmentStart: number | null; currentSegmentEnd: number | null }
    | { event: 'timeline-segment-sample'; slot: number; filename: string; phase: string; currentTime: number; playlistTime: number | null; mediaDuration: number | null; seekableEnd: number | null; playlistDuration: number | null; durationSource: 'playlist' | 'seekable' | 'media' | 'none' | 'live'; playbackToPlaylistScale: number; currentSegmentName: string | null; currentSegmentStart: number | null; currentSegmentEnd: number | null }
    | { event: 'native-ended-rejected'; slot: number; filename: string; verdict: 'rejected'; reason: 'playlist-not-exhausted'; currentTime: number; playlistTime: number | null; terminalTime: number; remaining: number; duration: number; durationSource: 'playlist' | 'seekable' | 'media' | 'none' | 'live'; mediaDuration: number | null; seekableEnd: number | null; currentSegmentName: string | null; currentSegmentStart: number | null; currentSegmentEnd: number | null }
    | { event: 'playback-ended-confirmed'; slot: number; filename: string; verdict: 'confirmed'; reason: 'live-ended' | 'no-playlist-authority' | 'playlist-ended'; currentTime: number; playlistTime: number | null; terminalTime: number; remaining: number; duration: number; durationSource: 'playlist' | 'seekable' | 'media' | 'none' | 'live'; mediaDuration: number | null; seekableEnd: number | null; currentSegmentName: string | null; currentSegmentStart: number | null; currentSegmentEnd: number | null }
    // Edit actions
