...
const ALLOWED_TRANSITIONS: Readonly<Record<PipelineState, readonly PipelineState[]>> = {
    ...
    described: ["provenance_review_required", "metadata_ready", "blocked", "failed"],
    provenance_review_required: ["described", "blocked", "failed"],
    metadata_ready: ["xvideos_admitted", "blocked", "failed"],
    xvideos_admitted: ["xvideos_uploading", "metadata_ready", "blocked", "failed"],
    xvideos_uploading: ["xvideos_uploaded", "xvideos_uncertain", "metadata_ready", "failed"],
    xvideos_uploaded: ["xvideos_verified", "xvideos_uncertain", "failed"],
    xvideos_uncertain: ["xvideos_uploaded", "metadata_ready", "failed"],
